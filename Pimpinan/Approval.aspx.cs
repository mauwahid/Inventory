...
public partial class Pimpinan_Approval : System.Web.UI.Page
{
    ...
    protected void BindPengajuan()
    {
        ...
        LblTotal.Text = reader["harga_total"].ToString();
    ...
    protected void GvBind()
    {
     ...
     /*   dataSource.SelectCommand = "select p.id, p.id_pengajuan, p.id_inventaris, p.qty, p.memo_kabag, p.gambar,p.created_date, " +
        ...
        */
        ...
        String query = "select p.id_pengajuan_inventaris, p.id_pengajuan_inventaris, p.id_inventaris, p.qty, p.catatan_kabag, p.created_date, p.harga_satuan, p.harga_total,"
    ...
    protected void BtnSetuju_Click(object sender, EventArgs e)
    {
      ...
      //  cmd.Parameters.AddWithValue("@id_user_pimpinan", "1");
        ...
        query = "Update t_pengajuan_inventaris set status_konfirmasi = 1, catatan_pimpinan = @memo, id_user_pimpinan = @id_user_pimpinan, approval_date = @approval_date where id_pengajuan = @id_pengajuan";
    ...
    protected void BtnRejected_Click(object sender, EventArgs e)
    {
        ...
        query = "Update t_pengajuan_inventaris set status_konfirmasi = 2, catatan_pimpinan = @memo, id_user_pimpinan = @id_user_pimpinan, approval_date = @approval_date where id_pengajuan = @id_pengajuan";
