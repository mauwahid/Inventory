...
public partial class Pimpinan_ListTersetujui : System.Web.UI.Page
{
    ...
    protected void GvBind()
    {
        ...
        dataSource.SelectCommand = "select id, no_pengajuan, judul_pengajuan, keterangan, kabag, created_date,  approval_date, "
                                 ...
                                 + "   from v_pengajuan where status_approval != 0"
                                 + "   order by id desc";
