...
public partial class Admin_JenisInventori_List : System.Web.UI.Page
{
    ...
    {
        Session["jenis_inventaris_form_type"] = "add";
    ...
    protected void GvBind()
    {
        ...
        string query = "Select * from m_jenis_inventaris";
        ...
        {
            dr = dt.NewRow();
            dr["Id"] = reader["id_jenis_inventaris"].ToString();
            dr["JenisInventaris"] = reader["nama_jenis_inventaris"].ToString();
            dt.Rows.Add(dr);
    ...
    protected void Delete(string id)
    {
        ...
        query = "delete m_jenis_inventaris where id_jenis_inventaris = " + id;
        cmd.CommandText = query;
    ...
    protected void RowEdit_Click(object sender, GridViewEditEventArgs e)
    {
        ...
        Session["jenis_inventaris_form_type"] = "edit";
        Session["jenis_inventaris_form_id"] = id;
        Response.Redirect("Form.aspx");
    ...
    protected void btnCari_Click(object sender, EventArgs e)
    {
        ...
        query = "select * from m_jenis_inventaris where nama_jenis_inventaris like '%" + param + "%'";
        cmd.CommandText = query;
