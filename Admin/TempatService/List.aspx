<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Admin_Distributor_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    ...
    <ol class="breadcrumb">
            ...
            <li class="active">Lokasi Service</li>
    </ol>
</asp:Content>
                ...
                <div class="box-body">
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="NamaLokasiService" HeaderText="Nama Lokasi Service" />
                                    <asp:BoundField DataField="Alamat" HeaderText="Alamat" />
                                    <asp:BoundField DataField="NoTelp" HeaderText="No Telepon" />
...
<asp:Content ID="Content4" ContentPlaceHolderID="JsContent" Runat="Server">
      <script type="text/javascript">
          ...
          $('#m_lokasi_service').addClass('active');
