...
public partial class Admin_Distributor_List : System.Web.UI.Page
{
    ...
    {
        Session["lokasi_service_form_type"] = "add";
    ...
    protected void GvBind()
    {
        ...
        string query = "Select * from m_lokasi_service";
        ...
        dt.Columns.Add("NamaLokasiService", typeof(string));
        ...
        {
            dr = dt.NewRow();
            dr["Id"] = reader["id_lokasi_service"].ToString();
            dr["NamaLokasiService"] = reader["nama_lokasi_service"].ToString();
    ...
    protected void Delete(string id)
    {
        ...
        query = "delete m_lokasi_service where id_lokasi_service = " + id;
        cmd.CommandText = query;
    ...
    protected void RowEdit_Click(object sender, GridViewEditEventArgs e)
    {
        ...
        Session["lokasi_service_form_type"] = "edit";
        Session["lokasi_service_form_id"] = id;
        Response.Redirect("Form.aspx");
    ...
    protected void btnCari_Click(object sender, EventArgs e)
    {
        ...
        query = "select * from m_lokasi_service where nama_lokasi_service like '%" + param + "%'";
        cmd.CommandText = query;
