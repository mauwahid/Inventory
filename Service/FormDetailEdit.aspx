<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="FormDetailEdit.aspx.cs" Inherits="Pengadaan_FormDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    ...
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-server"></i>Draft</a></li>
          ...
          <div class="box">
                ...
                <div class="box-footer clearfix">
                  ...
                  <asp:Button ID="BtnCancel"  CssClass="btn btn-warning"  
                        runat="server" Text="Simpan Draft" onclick="BtnCancel_Click"/>
