...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    ...
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i>Detail Service Inventaris</a></li>
            <li class="active">Detail Service Inventaris</li>
    </ol>
</asp:Content>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    <asp:BoundField DataField="id_pengajuan_service" HeaderText="Id" Visible="false" />
