...
public partial class Laporan_ReportPengajuan : System.Web.UI.Page
{
    ...
    private void GenerateReport()
    {
        ...
        ReportViewer1.Reset();
        ReportViewer1.LocalReport.ReportPath = "Laporan/PengajuanSvcDetail.rdlc";
    ...
    private DataTable GetData(string no)
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            string cond = "where id_pengajuan_service ='" + no + "'";

            query = "SELECT * FROM v_service_inventaris_detail " + cond;
    ...
    private PengajuanDomain GeneratePengajuan(string noId)
    {
        ...
        query = "select * from v_service where id_pengajuan_service like '" + noId + "' ";
        cmd.CommandText = query;

        conn.Open();
        SqlDataReader reader = cmd.ExecuteReader();
        reader.Read();
        pDomain.IDPengajuan = reader["id_pengajuan_service"].ToString();
        pDomain.Judul = reader["judul_pengajuan_service"].ToString();
