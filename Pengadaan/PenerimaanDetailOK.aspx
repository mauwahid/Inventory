<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="PenerimaanDetailOK.aspx.cs" Inherits="Pengadaan_PenerimaanDetail" %>
                ...
                <div class="box-body">
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="id_inventaris" HeaderText="ID INV" Visible="true"/>
                                    <asp:BoundField DataField="qty_diajukan" HeaderText="Jumlah Pengajuan" />
                                    <asp:BoundField DataField="catatan_pengajuan" HeaderText="Catatan Pengajuan" />
                                    <asp:BoundField DataField="qty_diterima" HeaderText="Jumlah Diterima" />
                                    <asp:BoundField DataField="keterangan" HeaderText="Catatan Penerimaan" />
