              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                   DataKeyNames="id_penerimaan"   AllowPaging="true"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="id_penerimaan" HeaderText="Id" Visible="true" />
                                    <asp:BoundField DataField="judul_penerimaan" HeaderText="Judul" />
                                    ...
                                    <asp:BoundField DataField="ref_pengajuan" HeaderText="Referensi Pengajuan" />
                                    <asp:BoundField DataField="creator" HeaderText="Petugas" />
                                      <asp:TemplateField HeaderText="Detail">
                                         <ItemTemplate>
                                           <asp:LinkButton ID="LinkButton1" 
                                             CommandArgument='<%# Eval("id_penerimaan") %>'
...
<script type="text/javascript">
    ...
    $('#m_teknisi_penerimaan').addClass('active');
    $('#m_teknisi_penerimaan_list').addClass('active');
