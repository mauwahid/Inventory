...
public partial class Pengadaan_ListPengadaan : System.Web.UI.Page
{
    ...
    protected void GvBind()
    {
        ...
        dataSource.SelectCommand = "SELECT  id_pengajuan, no_pengajuan, judul_pengajuan, "
                                  + "  catatan_kabag, kabag, REPLACE(CONVERT(VARCHAR(9), created_date, 6), ' ', '-') AS [created_date] "
                                  +"  From v_pengajuan where status_konfirmasi is NULL order by id_pengajuan desc;";
    ...
    protected void Delete(string id)
    {
        ...
        query = "delete t_pengajuan_inventaris where id_pengajuan = '" + id + "'";
        ...
        query = "delete t_pengajuan_inventaris_detail where id_pengajuan_inventaris = '" + id + "'";
        cmd.CommandText = query;
    ...
    protected void RowEdit_Click(object sender, GridViewEditEventArgs e)
    {
        ...
        cmd.Connection = conn;
        cmd.CommandType = System.Data.CommandType.Text;
        string id = GridView1.DataKeys[e.NewEditIndex]["id_pengajuan"].ToString();
    ...
    protected void btnCari_Click(object sender, EventArgs e)
    {
        ...
        dataSource.ConnectionString = ConfigurationManager.ConnectionStrings["InventoryConn"].ToString();
        dataSource.SelectCommand = "SELECT  id_pengajuan, no_pengajuan, judul_pengajuan, "
                                  + "  catatan_kabag, kabag, created_date"
                                  + "  From v_pengajuan where status_konfirmasi is NULL "
                                  + " and (id_pengajuan like '%"+param+"%' or no_pengajuan like '%"+param+"%'"
                                  + " or judul_pengajuan like '%"+param+"%') "
