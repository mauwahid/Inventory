...
public partial class Pengadaan_FormDetail : System.Web.UI.Page
{
    ...
    protected void BindPengajuan()
    {
        ...
        while (reader.Read())
        {
          ...
          //  LblNoPengajuan.Text = reader["no_pengajuan"].ToString();
            ...
            LblSurat.Text = reader["file_save"].ToString();

            if (!LblSurat.Text.Equals(""))
            {
    ...
    private void HitungTotalHarga()
    {
       ...
       // query = "update t_pengajuan_inventaris set harga_total = (select sum(harga_total) from t_pengajuan_inventaris_detail where id_pengajuan = @id_pengajuan) where id_pengajuan = @id_pengajuan";
