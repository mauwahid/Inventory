<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="Pengadaan_Detail" %>
                ...
                <div class="box-body no-padding">
                  ...
                  <tr>
                    ...
                    <td>Status Pengajuan</td>
                      <td><asp:Label runat="server" ID="LblStatusPengajuan" /></td>
                      <td>Catatan Pimpinan</td>
                      <td><asp:Label runat="server" ID="LblCatatanPimpinan" /></td>
                    </tr>
                     <tr>
                         <td></td>
                         <td></td>
                      <td>Tgl Approve</td>
                      <td><asp:Label runat="server" ID="LblTglApproval" /></td>
                    </tr>
                    </tr>
