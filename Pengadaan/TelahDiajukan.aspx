...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    <h1>
           List yang telah diajukan
            
    </h1>
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-server"></i>List Pengajuan</a></li>
    </ol>
</asp:Content>
                ...
                <div class="box-body">
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="form-group">
                                         <asp:DropDownList ID="DDLUrutkan" CssClass="form-control" runat="server" 
                                            ...
                                            <asp:ListItem Text="ID" Value="id_pengajuan"></asp:ListItem>
                                            <asp:ListItem Text="No Pengajuan" Value="no_pengajuan"></asp:ListItem>
                      ...
                      <div class="row">
                             <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    <asp:BoundField DataField="id_pengajuan" HeaderText="Id" Visible="false" SortExpression="Id" />
                                    ...
                                    <asp:BoundField DataField="status_konfirmasi_ket" HeaderText="Status" />
...
<script type="text/javascript">
    ...
    $('#m_kabag_pengajuan_telah').addClass('active');
