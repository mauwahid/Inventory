<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="Pembelian_Detail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NavContent" Runat="Server">
</asp:Content>
<asp:Content ID="Contsdent2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    <h1>
            Detail Pembelian Inventaris
            
    </h1>
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i>Pembelian</a></li>
            <li class="active">Detail Pembelian Inventaris</li>
    </ol>
</asp:Content>
                ...
                <div class="box-body">
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="id_pengajuan_inventaris" HeaderText="Id Pengajuan" Visible="false" />
