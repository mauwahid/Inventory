<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="ServiceKeluar_List" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NavContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    <h1>
            Service Keluar Barang
            
    </h1>
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i>Service Keluar Barang</a></li>
            <li class="active">List Service Keluar</li>
    </ol>
</asp:Content>
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                   DataKeyNames="Id_service_keluar"   AllowPaging="true"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="id_service_keluar" HeaderText="Id" Visible="false" />
                                    <asp:BoundField DataField="id_service_keluar" HeaderText="Id" />
                                    <asp:BoundField DataField="judul" HeaderText="Judul" />
                                    <asp:BoundField DataField="dt_svc" HeaderText="Tanggal" />
                                    <asp:BoundField DataField="id_pengajuan_service" HeaderText="Referensi Service" />
                                     ...
                                     <asp:TemplateField HeaderText="Detail">
                                         <ItemTemplate>
                                           <asp:LinkButton ID="LinkButton1" 
                                             CommandArgument='<%# Eval("id_service_keluar") %>'
