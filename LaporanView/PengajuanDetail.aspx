<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="PengajuanDetail.aspx.cs" Inherits="LaporanView_PengajuanDetail" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 col-md-offset-2">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label1" Text="ID/No Pengajuan : " runat="server" />
                             </div>
                             <div class="form-group">
                                <asp:TextBox ID="TbIDNoPengajuan" Text=""  runat="server" CssClass="form-control" />
                            </div>
                             <div class="form-group">
