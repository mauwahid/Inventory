<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="LapService.aspx.cs" Inherits="LaporanView_LapPembelian" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    <h1>
            Laporan Service Keluar
            
    </h1>
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i>Laporan</a></li>
            <li class="active">Service Keluar</li>
    </ol>
</asp:Content>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 col-md-offset-2">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label1" Text="Tgl Service Keluar : " runat="server" />
                             </div>
                             <div class="form-group">
