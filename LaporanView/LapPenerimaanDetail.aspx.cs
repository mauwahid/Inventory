...
public partial class LaporanView_LapPenerimaanDetail : System.Web.UI.Page
{
    ...
    private void GenerateReport()
    {
        ...
        parameters[0] = new ReportParameter("NoPenerimaan", peDomain.id);
    ...
    private PenerimaanDomain GeneratePenerimaan(string noId)
    {
        ...
        if (reader.Read())
        {
            ...
            pDomain.Hal = reader["judul_penerimaan"].ToString().Trim();
             pDomain.TglPenerimaan = reader["tanggal_penerimaan"].ToString();
