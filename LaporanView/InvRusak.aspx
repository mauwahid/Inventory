<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="InvRusak.aspx.cs" Inherits="LaporanView_InvRusak" %>
...
<script type="text/javascript">
    ...
    $('#m_kabag_laporan_rusak').addClass('active');
    $('#m_pimpinan_laporan').addClass('active');
    $('#m_pimpinan_laporan_rusak').addClass('active');
    $('#m_pencatat_laporan').addClass('active');
    $('#m_pencatat_laporan_rusak').addClass('active');
