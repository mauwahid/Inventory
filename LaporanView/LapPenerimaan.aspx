<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="LapPenerimaan.aspx.cs" Inherits="LaporanView_LapPenerimaan" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 col-md-offset-2">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label1" Text="Tgl Penerimaan : " runat="server" />
                             </div>
                             <div class="form-group">
