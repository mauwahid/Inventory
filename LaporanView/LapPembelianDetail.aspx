<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="LapPembelianDetail.aspx.cs" Inherits="LaporanView_LapPembelianDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    ...
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i>Laporan Pembelian</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 col-md-offset-2">
                            ...
                            <div class="form-group">
                                <asp:Label ID="Label1" Text="ID/No Pembelian : " runat="server" />
                             </div>
                             <div class="form-group">
                                <asp:TextBox ID="TbIDNoPembelian" Text=""  runat="server" CssClass="form-control" />
                            </div>
                             <div class="form-group">
