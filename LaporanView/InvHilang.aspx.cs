...
public partial class LaporanView_InvHilang : System.Web.UI.Page
{
    ...
    private void GenerateReport()
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "Laporan/InvHilang.rdlc";
    ...
    private DataTable GetData()
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            query = "SELECT * FROM v_inv_hilang " + cond;
            cmd.CommandText = query;
    ...
    private void RunPrint()
    {
        ...
        report.ReportPath = "Laporan/InvHilang.rdlc";
        DataTable dt = GetData();

        report.DataSources.Add(new ReportDataSource("RusakHilang", dt));
