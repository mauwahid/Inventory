...
public partial class LaporanView_LapPembelian : System.Web.UI.Page
{
    ...
    private void GenerateReport()
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "Laporan/Pembelian.rdlc";
        ReportViewer1.ShowPrintButton = true;

        ReportParameter[] parameters = new ReportParameter[2];
        parameters[0] = new ReportParameter("TglDari", TbTanggalDari.Text + " - "+ TbTanggalKe.Text);
    ...
    private DataTable GetData()
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            string cond = "where convert(char(10),tanggal,120) >= '" + TbTanggalDari.Text + "' and convert(char(10),tanggal,120) <= '" + TbTanggalKe.Text + "'";
    ...
    private void RunPrint()
    {
        ...
        report.ReportPath = "Laporan/Pembelian.rdlc";
        DataTable dt = GetData();
