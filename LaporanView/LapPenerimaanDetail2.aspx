<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="LapPenerimaanDetail2.aspx.cs" Inherits="LaporanView_LapPembelianDetail" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 col-md-offset-2">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <asp:TextBox ID="TbID" Text=""  runat="server" CssClass="form-control" />
                            </div>
                             <div class="form-group">
