...
public partial class LaporanView_LapPengajuan : System.Web.UI.Page
{
    ...
    private DataTable GetData()
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            string cond = "where convert(char(10),created_date,120) >= '" + TbTanggalDari.Text+ "' and convert(char(10),created_date,120) <= '"+TbTanggalKe.Text+"'";

            query = "SELECT * FROM v_pengajuan_report " + cond;
    ...
    private void RunPrint()
    {
        ...
        report.ReportPath = "Laporan/PengajuanInv.rdlc";
        DataTable dt = GetData();

        report.DataSources.Add(new ReportDataSource("DSet_V_Pengajuan_Report", dt));
        ReportParameter[] parameters = new ReportParameter[2];
        parameters[0] = new ReportParameter("TglDari", TbTanggalDari.Text);
        parameters[1] = new ReportParameter("TglKe", TbTanggalKe.Text);
