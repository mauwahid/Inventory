<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Template.master" CodeFile="PenugasanTeknisiDetail.aspx.cs" Inherits="Penugasan_PenugasanTeknisiDetail" %>
    ...
    <section class="content">
                ...
                <div class="box-footer clearfix">
                  <asp:Button ID="BtnTambah" 
                         CssClass="btn btn-primary" runat="server" Text="Mulai Dikerjakan"
                         OnClientClick="return confirm('Mulai Pengerjaan?')" 
