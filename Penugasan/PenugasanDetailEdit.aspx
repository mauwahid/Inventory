<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="PenugasanDetailEdit.aspx.cs" Inherits="Penugasan_PilihInventarisRusak" %>

<asp:Content ID="Content1" ContentPlaceHolderID="NavContent" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    <h1>
            Edit Detail Penugasan Teknisi
            
    </h1>
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i>Draft Penugasan</a></li>
            <li class="active">Edit Detail Penugasan</li>
    </ol>
</asp:Content>
           ...
           <div class="box">
                ...
                <div class="box-footer clearfix">
                   <asp:Button ID="BtnTambahTugas" 
                         CssClass="btn btn-success" runat="server" Text="Tambah Tugas Inventaris" 
                        onclick="BtnTambahTugas_Click"/>
                    <asp:Button ID="Button1" 
                         CssClass="btn btn-info" runat="server" Text="Tambah Pembelian" 
                        onclick="BtnTambahBeli_Click"/>
                        <asp:Button ID="Button2" 
                         CssClass="btn bg-purple" runat="server" Text="Tambah Service" 
                        onclick="BtnTambahService_Click"/>
                  <asp:Button ID="BtnSimpanPenugasan"
                        CssClass="btn bg-navy"  runat="server" 
                        Text="Kirim Penugasan" OnClick="BtnSimpan_Click"  OnClientClick="return confirm('Anda yakin akan menyimpan data penerimaan?')" />
                  <asp:Button ID="BtnDraft" OnClick="BtnDraft_Click"  CssClass="btn btn-warning"  runat="server" Text="Simpan Draft"/>
                  <asp:Button ID="BtnDelete" OnClick="BtnDeletePengajuan_Click"  
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="updated_date" HeaderText="Upd Date" Visible="true" />
                                     <asp:TemplateField HeaderText="Ubah">
                                         <ItemTemplate>
                                           <asp:LinkButton ID="LinkButto2" 
                                             CommandArgument='<%# Eval("Id") + ";"+ Eval("jenis") %>'
