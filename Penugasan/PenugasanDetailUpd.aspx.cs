...
public partial class Penugasan_PenugasanDetailUpd : System.Web.UI.Page
{
    ...
    private void InitDDLPembelian()
    {
        ...
        SqlConnection conn = Common.getConnection();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = "select distinct id_pembelian, (id_pembelian + ' - '+judul) as title from t_pembelian";
    ...
    private void InitDDLService()
    {
        ...
        SqlConnection conn = Common.getConnection();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = "select distinct id_service, (id_service + ' - '+judul) as title from t_service_keluar";

        cmd.Connection = conn;
        conn.Open();

        DDLService.DataSource = cmd.ExecuteReader();
        DDLService.DataValueField = "id_service";
