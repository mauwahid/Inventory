<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="OnProgressTeknisi.aspx.cs" Inherits="Penugasan_OnProgressTeknisi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    ...
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i>Penugasan Berjalan</a></li>
    </ol>
</asp:Content>
...
<script type="text/javascript">
    ...
    $('#m_teknisi_penugasan_onprogress').addClass('active');
