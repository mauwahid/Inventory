<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="PenugasanDetail.aspx.cs" Inherits="Penugasan_PilihInventarisRusak" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" Runat="Server">
    ...
    <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i>Tambah Penugasan</a></li>
                   ...
                   <asp:Button ID="BtnTambahTugas" 
                    ...
                    <asp:Button ID="Button1" 
                        ...
                        <asp:Button ID="Button2" 
                         CssClass="btn bg-purple" runat="server" Text="Tambah Service Keluar" 
